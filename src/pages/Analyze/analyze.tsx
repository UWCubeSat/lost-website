        ...
        if (res.status !== 200) {
          ...
          setOutput({
            ...
            attitudeString: Object.entries(parsedData.image_analysis)
              .map(
                ([key, value], index) =>
                  `<strong>${dataLabels[index]}:</strong> ${value == 1 ? 'True' : value == 0 ? 'False' : value}`,
              )
      ...
      <div className="w-full flex items-stretch justify-center mt-12 gap-5">
            ...
            <section className="w-full border-dashed border-2 px-8 py-6 border-gray-400 rounded-2xl flex items-center justify-center">
              <div {...getRootProps({ className: 'dropzone' })}>
                ...
                <div className="w-full justify-center items-center flex flex-col">
                  ...
                  <h3 className="mt-6 font-bold text-gray-800 text-[14px]">
                    Choose a file or drag & drop it here
                  </h3>
                  <h3 className="mt-2 text-gray-500 text-[13px]">
                    JPG and PNG images, up to 5MB
                  </h3>
                  <button className="rounded-lg border border-gray-400 text-gray-700 text-[13px] py-1 px-3 mt-4 cursor-pointer">
                    Browse File
                  </button>
                </div>
              </div>
          ...
          {flow === 'processed' && (
            <>
              ...
              <div className="mt-4">
                ...
                <pre
                  className="text-[12px] bg-gray-200 px-3 py-2"
        ...
        <div className="w-[400px] bg-gray-50 px-4 rounded-2xl py-2">
          ...
          <div className="flex gap-1 flex-col mt-2">
            <span className="text-sm font-bold">Focal Length (in mm)</span>
            <input
              type="number"
              className="border border-gray-400 rounded-md px-2 py-1 text-sm"
              min={1}
